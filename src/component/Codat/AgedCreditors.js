...
export default function AgedCreditors(props) {
  ...
  const generateData = async () => {
    if (dayLength !== "" && noOfPriod !== "" && startDate !== "") {
      setLoading(true);
      const finalUrl = `${props.endUrl}/CODAT/Aged_Creditors${reportBy}/${props.leadId}/${dayLength}/${noOfPriod}/${startDate}`;
  ...
  return (
    <div>
      {loading && <Loaderspinner size="45px" />}
      <div className="col-md-12 no-padding">
        <h3>Aged Creditors</h3>
      </div>
      <div className="row">
        ...
        <div className="col-md-2  debtors">
          ...
          <input
            ...
            value={noOfPriod}
            onChange={(e) => setNoOfPriod(e.target.value)}
          />
        </div>
      ...
      <div className="com-md-12">
        <div className="row">
          ...
          <div className="col-md-2 debtors">
            <label className="group-report">Group report by</label>
          </div>
          <div className="col-md-2 debtors">
            <select
              className="group"
            ...
            >
              ...
              <option value="_group">Creditor</option>
            </select>
          </div>
        </div>
        {resultData && (
          <div className="">
            <div className="table-data-div">
              ...
              <div className="col s12" id="groupcred"></div>
            </div>
          </div>
        )}
      </div>
